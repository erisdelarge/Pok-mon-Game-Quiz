...
for(i=0;i<results.length;i++){
    ...
    if(i>=1004&&i<=1025){pmnName=pmnName.replace("-"," ")} ;

    if(i==28){pmnName="nidoran♀"};
    if(i==31){pmnName="nidoran♂"};
    if(i==82){pmnName="farfetch'd"};if(i==121){pmnName="mr. mime"};if(i==385){pmnName="deoxys"};if(i==412){pmnName="wormadam"};if(i==438){pmnName="mime jr."};if(i==486){pmnName="giratina"};if(i==491){pmnName="shaymin"};if(i==549){pmnName="basculin"};if(i==554){pmnName="darmanitan"};if(i==640){pmnName="tornadus"};if(i==641){pmnName="thundurus"};if(i==644){pmnName="landorus"};if(i==646){pmnName="keldeo"};if(i==647){pmnName="meloetta"};if(i==668){pmnName="flabebe"};if(i==677){pmnName="meowstic"};if(i==680){pmnName="aegislash"};if(i==709){pmnName="pumpkaboo"};if(i==710){pmnName="gourgeist"};if(i==717){pmnName="zygarde"};if(i==740){pmnName="oricorio"};if(i==744){pmnName="lycanroc"};if(i==745){pmnName="wishiwashi"};if(i==771){pmnName="type: null"};if(i==773){pmnName="minior"};if(i==777){pmnName="mimikyu"};if(i==784){pmnName="tapu koko"};if(i==785){pmnName="tapu lele"};if(i==786){pmnName="tapu bulu"};if(i==787){pmnName="tapu fini"};if(i==848){pmnName="toxtricity"};if(i==864){pmnName="sirfetch'd"};if(i==865){pmnName="mr. rime"};if(i==874){pmnName="eiscue"};if(i==875){pmnName="indeedee"};if(i==876){pmnName="morpeko"};if(i==891){pmnName="urshifu"};if(i==901){pmnName="basculegion"};if(i==904){pmnName="enamorus"};
